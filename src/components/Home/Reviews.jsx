            ...
            <div className="mt-8 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-2">
              <blockquote>
                ...
                <p className="mt-2 text-gray-700">
                  Lego toys: Interlocking bricks inspiring creativity,
                  imagination, and endless possibilities for children and adults
                  alike.
                </p>
              ...
              <blockquote>
                ...
                <p className="mt-2 text-gray-700">
                  Lego toys: Building blocks that spark curiosity, encourage
                  problem-solving, and bring joy through imaginative play.
                </p>
